...
source "$PLUTUS_DEVS_SCRIPTS/env/write-env-list-testnet-preview.sh"
...
lineNew="[ -f \"$PLUTUS_DEVS_SCRIPTS/env/write-env-list-testnet-preview.sh\" ] && source \"$PLUTUS_DEVS_SCRIPTS/env/write-env-list-testnet-preview.sh\" # falcon-devs-env"
