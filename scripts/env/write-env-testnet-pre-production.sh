...
source "$PLUTUS_DEVS_SCRIPTS/env/write-env-list-testnet-pre-production.sh"
...
lineNew="[ -f \"$PLUTUS_DEVS_SCRIPTS/env/write-env-list-testnet-pre-production.sh\" ] && source \"$PLUTUS_DEVS_SCRIPTS/env/write-env-list-testnet-pre-production.sh\" # falcon-devs-env"
